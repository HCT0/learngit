...
#打开一个文件路径
fp =open ('doubanbook.txt','wt',newline='',encoding ='utf-8')
...
for url in urls:
    #获取网页
    html = requests.get(url,header=headers)
    #解析网页
    selector = etree.HTML(html.text)
    titles = selector.xpath('//*[@id="content"]/div/div[1]/div/table/tbody/tr/td[2]/div[1]/a')
